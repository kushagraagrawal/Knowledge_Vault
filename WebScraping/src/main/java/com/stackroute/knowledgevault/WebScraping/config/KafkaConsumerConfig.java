...
//        config.put(ConsumerConfig.MAX_PARTITION_FETCH_BYTES_CONFIG, 1000000000);
    ...
    @Bean
    public ConsumerFactory<String, POJOClass> documentConsumerFactory(){
...
//        config.put(ConsumerConfig.MAX_PARTITION_FETCH_BYTES_CONFIG, 1000000000);
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),new JsonDeserializer<>(POJOClass.class));
    }
